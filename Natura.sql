/* =========================================================
   BASE DE DATOS: NATURAL_F
   MOTOR: POSTGRESQL
   ========================================================= */

/*
IMPORTANTE:
1. Ejecuta primero, conectado a la base "postgres":
...
2. Después conéctate a la base de datos natural_f.
3. PostgreSQL no utiliza el comando USE.
*/
